...
Výsledky segmentace jsou zaznamenány v tabulce \ref{table:test-do} a ukázka výsldné segmentace z různých úhlů je vidět na obrázku \ref{fig:test-do}.
...
Vstupní mračno je zobrazeno na obrázku \ref{fig:faust}. Toto mračno je největší, které jsem měl při testování k dispozici, obsahuje necelých 1,5 milionu bodů.
