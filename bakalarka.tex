...
\noindent
Tady možná jeden odstavec, proč je vlastně segmentace důležitá
\noindent
Cílem této bakalářské práce je implementovat dva algoritmy, které budou rychle, efektivně a kvalitně
segmentovat mračno 3D bodů na planární primitiva. Algoritmy jsou implementovány jako součást 3D
rekonstrukčního nástroje ArchiRec3D. Práce nejprve teoreticky popisuje jednotlivé algorimy, v další části jsou
poté oba algoritmy prakticky implementovány. V závěru práce je otestována správná funkčnost algoritmů na umělě
generovaných datech a zároveň je porovnána funkčnost obou algoritmů na reálných datech.
...
\section*{}
Určitě existuje nějaká pěkná latinská věta, která se k tomuhle testování používá, ale co mají dělat ti, kteří
se  nikdy latinsky neučili? Určitě existuje nějaká pěkná latinská věta, která se k tomuhle testování používá,
ale co mají dělat ti, kteří se nikdy latinsky neučili? Určitě existuje nějaká pěkná latinská věta, která se k
tomuhle testování používá, ale co mají dělat ti, kteří se nikdy latinsky neučili?
