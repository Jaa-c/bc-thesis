...
Výpočet parametrů bodu prbíhá konkrétně tak, že výsledným okolím bodu proložíme rovinu. Vypočítáme vzdálenost této roviny od obou refenčních bodů a tím získáme dvojici parametrů bodu. Na základě těchto parametrů je poté bod uložen do akumulátorového pole.
...
jaký soubory mám, co v nich je, jaký mám třídy a jaký maj metody\ldots
